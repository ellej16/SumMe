...
import summe_app.Summarizer.NLG.pynlg.morphology as morph

DEFAULT_PATH = os.path.realpath("C:/users/rihanna/Documents/pol/ThesisIt/SumMe/WebApp/summe_project/summe_app/Summarizer/NLG/default-lexicon.xml")
