...
import summe_app.Summarizer.NLG.pynlg.fil_morphology as fil_morph

#Filipino Corpus
DEFAULT_PATH = os.path.realpath("C:/users/rihanna/Documents/pol/ThesisIt/SumMe/WebApp/summe_project/summe_app/Summarizer/NLG/filipino-lexicon.xml")
...
class Lexicon():
    ...
    def makeVariants(self, word_elem):
        for variant in fil_morph.makeVariants(word_elem):
            self.words_by_variants[variant].append(word_elem)
    
    def makeInflections(self, word_elem):
        inflections = fil_morph.makeInflections(word_elem)
